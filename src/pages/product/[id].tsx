                ...
                <div className="flow-root">
                  <div className="-m-0.5 flex flex-wrap">
                    ...
                    <label htmlFor="size_s" className="cursor-pointer p-0.5">
                      ...
                      <span className="inlineW-flex items-center justify-center w-8 h-8 text-xs font-medium border rounded-full group peer-checked:bg-black peer-checked:text-white">
                        S
                      </span>
                    </label>
